...
public abstract class EnemyClass : MonoBehaviour
{
    ...
    public virtual void KillEntity()
    {
        ...
        else
        {
            ...
            if (transform.name == "The Revenant") GameObject.Find("Spawner").GetComponent<EnemySpawner>().defeatBoss(0);
            else if (transform.name == "The Kraken") GameObject.Find("Spawner").GetComponent<EnemySpawner>().defeatBoss(1);
